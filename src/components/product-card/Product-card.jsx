...
const ProductCard = ({ product }) => {
  ...
  return (
    <Link
      ...
      className="relative flex flex-col border rounded-lg p-7"
    >
      <img className="w-full h-294" src={product.image} alt="" />
      <div className="flex flex-col items-start space-x-2 product-card__content">
        <div className="title">
          <h1 className="text-base font-bold text-text dark:text-white">
            {product.title}
          </h1>
        </div>
